...
public class StoreSafeManager
{
    ...
    protected StoreSafeManager() {
        this.db = new DatabaseManager("/home/rafox/NetBeansProjects/safestore/safestore/db/safestore_test.db");
    ...
    public boolean downloadFile(String path, StoreSafeFile file) 
    {
        return true;
        //this.db.file.
